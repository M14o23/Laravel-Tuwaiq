              ...
              <div class="col-lg-6 px-5 py-4">
                ...
                <div class="d-flex align-items-center mb-5">
                    <div class="flex-shrink-0">
                        ...
                        <img src="/assest\{{$item->images}}" alt="" width="150px" height="150px">
                    </div>
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h6 class="text-danger"><small><del> Descount : {{$item->desc}} SAR</del></small></h6>
                        <div class="d-flex align-items-center">
                            <p class="fw-bold mb-0 me-5 pe-3">{{ $item->net }}$</p>
...
?>   
                ...
                <div class="d-flex justify-content-between px-x">
                  ...
                  <p class="fw-bold">{{ $totaldesc }}$</p>
                </div>
                <div class="d-flex justify-content-between p-2 mb-2" style="background-color: #e1f5fe;">
                <h5 class="fw-bold mb-0">Total:</h5>
                <h5 class="fw-bold mb-0">{{ $totalNet }}$</h5> 
                </div>
